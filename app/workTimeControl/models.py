...
class paidBySalary(models.Model):
    ...
    date = models.DateField(blank=True, null=True)
    regular_hours = models.IntegerField(null=True, blank=True)
    vacation_hours = models.IntegerField(null=True, blank=True)
    sick_hours = models.IntegerField(null=True, blank=True)
